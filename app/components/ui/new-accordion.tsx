  ...
  return (
    <div className="mb-2 border-b border-gray-200 dark:border-gray-700 transition-colors">
      <div
        role="button"
        tabIndex={0}
        className="w-full text-left py-4 font-semibold text-lg flex justify-between items-center focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:ring-offset-2 dark:focus-visible:ring-offset-gray-900 transition-colors group cursor-pointer"
